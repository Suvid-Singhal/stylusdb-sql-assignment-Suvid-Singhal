...
function parseQuery(query) {
    ...
    if (joinPart){
        const parsedJoinQuery = parseJoinClause(query);
        joinType=parsedJoinQuery['joinType'];
        joinTable=parsedJoinQuery['joinTable'];
        joinCondition=parsedJoinQuery['joinCondition'];
    }
